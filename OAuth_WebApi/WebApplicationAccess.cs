...
namespace OAuth_WebAPI
{
    public class WebApplicationAccess
    {
        ...
        static WebApplicationAccess()
        {
           ...
           WebApplicationAccessList.TryAdd("6uQkxJCD9xTPGXyiGr_UbBFiofTqa7j5", new WebApplicationAccess()
           {
               //AccessKey = "",
               SecretKey = "JXxpSyYY-Bgz2LUruLW_L77N8o8mC90cNdSHSU6v-TJKJOjA2Q6mHtBuj5pKppsm",
               ApplicationName = "OAuth_WebAPI",
               ClientId = "6uQkxJCD9xTPGXyiGr_UbBFiofTqa7j5"
           });
        }
